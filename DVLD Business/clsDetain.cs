...
namespace DVLD_Business
{
    public class clsDetain
    {
        ...
        private bool _AddNewDetainedLicense()
        {
            ...
            this.DetainID = clsDetainData.AddDetainedLicense(
                this.LicenseID, this.FineFees, this.CreatedByUserID);
        ...
        private bool _UpdateDetainedLicense()
        {
            ...
            return clsDetainData.UpdateDetainedLicense(
        ...
        {
            return clsDetainData.GetAllDeatainedLicenses();
        ...
        public static clsDetain FindByLicenseID(int LicenseID)
        {
            ...
            if (clsDetainData.GetDetainedLicenseInfoByLicenseID(LicenseID,
        ...
        {
            return clsDetainData.ReleaseLicense(this.DetainID,
                   ReleasedByUserID, ReleaseApplicationID);
        }
    }
}
